...
function medianaEmpresaYear(nombre,year){
    ...
    console.warn('La empresa no dio salaros ese año');
    }else{
...
function proyeccionPorEmpresa(nombre){
    ...
    const aumentoSalario=ultimaMediana*medianaPorcentajesCrecimiento;
    const nuevoMediana =ultimaMediana+aumentoSalario;
